...
namespace DotRas.Internal
{
    ...
    internal interface IRasHelper
    {
        ...
        IEnumerable<RasConnection> GetActiveConnections();
        ...
        IEnumerable<RasDevice> GetDevices();
        ...
        RasEntry GetEntryProperties(string phoneBookPath, string entryName);
        ...
        RasSubEntry GetSubEntryProperties(string phoneBookPath, string entryName, int subEntryId);
        ...
        NativeMethods.RASENTRYNAME[] GetEntryNames(string phoneBookPath);
        ...
        bool IsValidEntryName(string phoneBookPath, string entryName, params int[] acceptableResults);
        ...
        /// <returns><b>true</b> if the operation was successful, otherwise <b>false</b>.</returns>
        bool SetEntryProperties(string phoneBookPath, RasEntry value);
        ...
        /// <returns><b>true</b> if the operation was successful, otherwise <b>false</b>.</returns>
        bool SetSubEntryProperties(string phoneBookPath, string entryName, int subEntryId, RasSubEntry value);

...
namespace DotRas
{
    ...
    public sealed partial class RasConnectionWatcher : RasComponent, ISupportInitialize
    {
        ...
        private IEnumerable<RasConnection> _lastState;
        ...
        private static RasConnection FindEntry(IEnumerable<RasConnection> collectionA, IEnumerable<RasConnection> collectionB)
        {

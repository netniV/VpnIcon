...
namespace DotRas
{
    ...
    public sealed class RasAutoDialManager : Component
    {
        ...
        public bool DisableConnectionQuery
        {
            get
            {
                return RasHelper.Default.GetAutoDialParameter(NativeMethods.RASADP.DisableConnectionQuery) != 0;
            }
            ...
            set
            {
                ...
                RasHelper.Default.SetAutoDialParameter(NativeMethods.RASADP.DisableConnectionQuery, actual);
            }
        }
        ...
        public bool LogOnSessionDisable
        {
            get
            {
                return RasHelper.Default.GetAutoDialParameter(NativeMethods.RASADP.LogOnSessionDisable) != 0;
            }
            ...
            set
            {
                ...
                RasHelper.Default.SetAutoDialParameter(NativeMethods.RASADP.LogOnSessionDisable, actual);
            }
        }
        ...
        public int SavedAddressesLimit
        {
            get
            {
                return RasHelper.Default.GetAutoDialParameter(NativeMethods.RASADP.SavedAddressesLimit);
            }

            set
            {
                RasHelper.Default.SetAutoDialParameter(NativeMethods.RASADP.SavedAddressesLimit, value);
            }
        }
        ...
        public int FailedConnectionTimeout
        {
            get
            {
                return RasHelper.Default.GetAutoDialParameter(NativeMethods.RASADP.FailedConnectionTimeout);
            }

            set
            {
                RasHelper.Default.SetAutoDialParameter(NativeMethods.RASADP.FailedConnectionTimeout, value);
            }
        }
        ...
        public int ConnectionQueryTimeout
        {
            get
            {
                return RasHelper.Default.GetAutoDialParameter(NativeMethods.RASADP.ConnectionQueryTimeout);
            }

            set
            {
                RasHelper.Default.SetAutoDialParameter(NativeMethods.RASADP.ConnectionQueryTimeout, value);
            }
        }
        ...
        {
            return RasHelper.Default.SetAutoDialEnable(dialingLocation, enabled);
        }
        ...
        {
            return RasHelper.Default.GetAutoDialEnable(dialingLocation);
        }

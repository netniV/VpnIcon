...
namespace DotRas
{
    ...
    public sealed class RasEntry
    {
        ...
        private ObservableCollection<RasSubEntry> subEntries;
...
#pragma warning restore 0618
        ...
        /// </summary>
        /// <remarks>Setting this member to a value other than <see cref="System.Net.IPAddress.Any"/> will cause the 'Use the following IP address' option to be set for TCP/IPv4.</remarks>
        ...
        /// </summary>
        /// <remarks>Setting this member to a value other than <see cref="System.Net.IPAddress.Any"/> will cause the 'Use the following DNS server addresses' option to be set for TCP/IPv4.</remarks>
        ...
        /// </summary>
        public ObservableCollection<RasSubEntry> SubEntries
        {
            get
            {
                if (this.subEntries == null)
                {
                    this.subEntries = new ObservableCollection<RasSubEntry>();
                }
        ...
        /// <remarks>
        /// <para>
        /// Setting this member to a value other than <see cref="System.Net.IPAddress.Any"/> will cause the 'Use the following DNS server addresses' option to be set for TCP/IPv6.
        /// </para>
        /// <para>
        ...
        /// <remarks>
        /// <para>
        /// Setting this member to a value other than <see cref="System.Net.IPAddress.Any"/> will cause the 'Use the following IP address' option to be set for TCP/IPv6.
        /// </para>
        /// <para>
        ...
        public bool ClearCredentials()
        {
            ...
            return RasHelper.Default.SetCredentials(this.Owner.FileName, this.Name, credentials, true);
        }
        ...
        public NetworkCredential GetCredentials()
        {
            ...
            return RasHelper.Default.GetCredentials(this.Owner.FileName, this.Name, NativeMethods.RASCM.UserName | NativeMethods.RASCM.Password | NativeMethods.RASCM.Domain);
        }
        ...
        public NetworkCredential GetCredentials(RasPreSharedKey key)
        {
            ...
            return RasHelper.Default.GetCredentials(this.Owner.FileName, this.Name, value);
        }
        ...
        public byte[] GetCustomAuthData()
        {
            ...
            return RasHelper.Default.GetCustomAuthData(this.Owner.FileName, this.Name);
        }
        ...
        public byte[] GetEapUserData()
        {
            ...
            return RasHelper.Default.GetEapUserData(IntPtr.Zero, this.Owner.FileName, this.Name);
        }
        ...
        ////    else
        ////    {
        ////        if (!RasHelper.Instance.IsValidEntryName(this.Owner.Path, newEntryName))
        ////        {
        ...
        public bool UpdateCustomAuthData(byte[] data)
        {
            ...
            return RasHelper.Default.SetCustomAuthData(this.Owner.FileName, this.Name, data);
        }
        ...
        public bool UpdateEapUserData(byte[] data)
        {
            ...
            return RasHelper.Default.SetEapUserData(IntPtr.Zero, this.Owner.FileName, this.Name, data);
        }
        ...
        public bool UpdateCredentials(NetworkCredential value)
        {
            ...
            return Utilities.UpdateCredentials(this.Owner.FileName, this.Name, value, RasUpdateCredential.User);
        }
        ...
        public bool UpdateCredentials(NetworkCredential value, bool storeCredentialsForAllUsers)
        {
            ...
            return Utilities.UpdateCredentials(this.Owner.FileName, this.Name, value, storeCredentialsForAllUsers ? RasUpdateCredential.AllUsers : RasUpdateCredential.User);
        }
        ...
        public bool UpdateCredentials(RasPreSharedKey key, string value)
        {
            ...
            return RasHelper.Default.SetCredentials(this.Owner.FileName, this.Name, credentials, false);
        }

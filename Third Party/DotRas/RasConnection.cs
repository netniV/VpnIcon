...
namespace DotRas
{
    ...
    public sealed class RasConnection
    {
        #region Fields
        ...
        public static IEnumerable<RasConnection> GetActiveConnections()
        {
            return RasHelper.Default.GetActiveConnections();
        }
        ...
        {
            return RasHelper.Default.GetConnectionStatus(this.Handle);
        }
        ...
        {
            return RasHelper.Default.GetConnectionStatistics(this.Handle);
        }
        ...
        {
            return RasHelper.Default.ClearConnectionStatistics(this.Handle);
        }
        ...
        {
            return RasHelper.Default.ClearLinkStatistics(this.Handle, this.SubEntryId);
        }
        ...
        {
            return RasHelper.Default.GetLinkStatistics(this.Handle, this.SubEntryId);
        }
        ...
        {
            return RasHelper.Default.GetNapStatus(this.Handle);
        }
        ...
        public object GetProjectionInfo(RasProjectionType projectionType)
        {
            ...
            if (projectionType == RasProjectionType.Ppp || projectionType == RasProjectionType.IkeV2)
            {
                ...
                object retval = RasHelper.Default.GetProjectionInfoEx(this.Handle);
            ...
            return RasHelper.Default.GetProjectionInfo(this.Handle, projection);
        }
        ...
        public RasHandle GetSubEntryHandle(int subEntryId)
        {
            ...
            return RasHelper.Default.GetSubEntryHandle(this.Handle, subEntryId);
        }
        ...
        public void HangUp(int pollingInterval, bool closeAllReferences)
        {
            ...
            RasHelper.Default.HangUp(this.Handle, pollingInterval, closeAllReferences);
        }        
        ...
        {
            RasHelper.Default.UpdateConnection(this.Handle, interfaceIndex, localEndPoint, remoteEndPoint);
        }
